...
exports.GetExercisesUseCase = void 0;
const common_1 = require("@nestjs/common");
const exercise_repository_1 = require("../domain/exercise.repository");
let GetExercisesUseCase = class GetExercisesUseCase {
    exerciseRepository;
...
exports.GetExercisesUseCase = GetExercisesUseCase = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, common_1.Inject)(exercise_repository_1.IExerciseRepository)),
    __metadata("design:paramtypes", [Object])
], GetExercisesUseCase);
//# sourceMappingURL=get-exercises.usecase.js.map