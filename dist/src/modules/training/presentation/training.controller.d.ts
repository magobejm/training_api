...
export declare class TrainingController {
    ...
    constructor(createPlanUseCase: CreateTrainingPlanUseCase, getPlanUseCase: GetTrainingPlanUseCase, getPlansUseCase: GetTrainingPlansUseCase, addDayUseCase: AddDayToPlanUseCase, addExerciseUseCase: AddExerciseToDayUseCase);
