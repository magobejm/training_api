...
class ScheduledWorkout {
    ...
    createdAt;
    updatedAt;
    constructor(id, userId, trainerId, trainingDayId, scheduledFor, reminderSent, completed, notes, createdAt, updatedAt) {
        this.id = id;
        this.userId = userId;
    ...
    reschedule(newDate) {
        return new ScheduledWorkout(this.id, this.userId, this.trainerId, this.trainingDayId, newDate, this.reminderSent, this.completed, this.notes, this.createdAt, new Date());
    }
}
